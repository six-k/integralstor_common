...
from integralstor_utils import command, disks, ramdisk, config, scheduler_utils, db
...
def get_exposed_ds_zvol_properties(properties):
    ...
    try:
        ...
        readonly_properties = ['type', 'creation', 'compressratio', 'mounted', 'usedbysnapshots',
                               'usedbydataset', 'usedbychildren', 'written', 'logicalused', 'logicalreferenced']
        modifyable_properties = {}
        for prop_name, prop in exposed_properties.items():
            if prop_name not in readonly_properties:
                modifyable_properties[prop_name] = prop
        ...
        return_dict['modifyable_properties'] = modifyable_properties
    except Exception, e:
