...
from integralstor_utils import command, disks, ramdisk, config, scheduler_utils, db, filesize
...
def get_free_disks(disk_type=None, spares_are_free_disks=False):
    ...
    try:
        ...
        all_disks, err = disks.get_disk_info_status_all(rescan=False, type='info')
        if not all_disks:
