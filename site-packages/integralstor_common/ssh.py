...
def get_ssh_key():
  try:
    copyfile("/root/.ssh/id_rsa.pub","/opt/integralstor/integralstor_unicell/integral_view/static/id_rsa.pub")
    return "id_rsa.pub"
  except Exception,e:
    return False  
...
def get_host_identity_key():
  try:
    copyfile("/etc/ssh/ssh_host_rsa_key.pub","/opt/integralstor/integralstor_unicell/integral_view/static/ssh_host_rsa_key.pub")
