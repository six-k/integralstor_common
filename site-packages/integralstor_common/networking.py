    ...
    if init_type not in ['systemd', 'init']:
      ...
      if err:
        ...
        for slave in slaves:
          ...
          cmd_con_up = "nmcli con up %s" %slave
...
def set_interface_ip_info(if_name, d):
  try:
    ...
    if init_type not in ['systemd', 'init']:
      ...
      cmd_set_ip = "nmcli con mod %s ipv4.method manual connection.autoconnect yes ipv4.addresses %s ipv4.gateway %s" %(if_name, if_addr, if_gw)
