...
def get_services_list ():
  services = [('ntpd','NTP'), ('smb', 'CIFS - smb'), ('winbind', 'CIFS - winbind'), ('tgtd', 'ISCSI'), ('nfs', 'NFS'),('vsftpd','FTP'),('shellinaboxd','Shell Access'),('urbackup-server','UrBackup Server')]
  if services:
    ...
    if not err:
      ...
      if rc == 0:
        ...
        if rc == 0:
          ...
          d['status_str'] = "Inactive"
        else:
          d['status_str'] = "Unknown state"
