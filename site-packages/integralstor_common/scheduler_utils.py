...
def get_background_jobs(db_path,minutes=1440):
...
def get_background_job(db_path,task_id):
  ...
  return read_single_row(db_path,tasks)[0]
...
def main():
  ...
  #  if count < 18:
  #    schedule_a_job(db_path,jobname,[{'cmd1':'echo'},{'cmd2':'echo'},{'cmd3':'pwd'}])
  #  else:
  #    schedule_a_job(db_path,jobname,[{'cmd1':'echo123'},{'cmd2':'ecdsfsdho'},{'cmd3':'spsdfawd'}])
  print execute_scheduler(db_path)
