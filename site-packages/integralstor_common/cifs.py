from integralstor_utils import command, db, common
...
def generate_common_share_body(f, workgroup, path, read_only, browseable, comment, extra_share_param_lines=None):
