...
def get_admin_vol_mountpoint():
  platform, err = get_platform()
  if platform:
    return "/opt/integralstor/integralstor-%s/mnt/admin_vol"%platform
  else:
    return None
